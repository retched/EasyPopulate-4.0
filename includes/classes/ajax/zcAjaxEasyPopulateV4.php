...
//    require_once $ep4_prefix . $ep4_extra_funcs_path;
//}
...
posted:
[ep_export_type] => 4
[ep_category_filter] => 1
[ep_manufacturer_filter] => 0
[ep_status_filter] => 1
*/
...
//            return false;
        ...
        //$result = ep4_get_category_tree('ep_category_filter', ep4_get_category_tree('', '', '0', array(array('id' => '', 'text' => EASYPOPULATE_4_DD_FILTER_CATEGORIES), array('id' => '0', 'text' => TEXT_TOP)), '', true, false, true, true, false, $ep_status_filter), $ep_category_filter);
