...
/*		if (ep_4_CEONURIExists() == true && !(EP4_AUTOCREATE_FROM_BLANK == '0' && EP4_AUTORECREATE_EXISTING == '0')) {
    ...
    $_SESSION['notify-extra-functions'] = ($ep4CEONURIDoesExist ? 'true' : 'false');
    $_SESSION['notify-extra-functions-vars'] = $ceon_uri_mapping_product_pages;
...
/*			if (false && $ep4CEONURIDoesExist == true && !(EP4_AUTOCREATE_FROM_BLANK == '0' && EP4_AUTORECREATE_EXISTING == '0')) { 
...
/*		break;*/
  ...
  case 'orders_4': // Attributes Only
	...
	$_SESSION['filelayout_sql'] = $filelayout_sql;
