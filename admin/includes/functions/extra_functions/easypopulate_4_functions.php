<?php
// $Id: easypopulate_4_functions.php, v4.0.24CEON 08-04-2014 mc12345678 $
...
function install_easypopulate_4() {
	...
	if ( (substr($project,0,5) == "1.3.8") || (substr($project,0,5) == "1.3.9") ) {
		...
		$db->Execute("INSERT INTO ".TABLE_CONFIGURATION." (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES 
			...
			('AutoCreate Category URL For CEON - All Products','EP4_AUTORECREATE_CAT_EXISTING','0','Enable Autogeneration of Category URIs with CEON (When it is installed) for all products on export?<br /><br />No - Do not alter categories based on this setting.<br /><br />Yes - Assign all categories the default CEON URI.<br /><br />Mixed - Assign the default CEON URIs for categories already assigned a URI and by the setting of AutoCreate URL For CEON When URL Doesn\'t Exist.<br />',".$group_id.", '30', NULL, now(), NULL, 'zen_cfg_select_drop_down(array(array(''id''=>''1'',''text''=>''Yes''),array(''id''=>''0'',''text''=>''No''),array(''id''=>''2'',''text''=>''Mixed'')),'),
