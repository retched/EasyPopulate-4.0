...
//			} // end of special case 'attrib_basic'
	...
	if ($ep_dltype == 'full') {
		...
		foreach ($langcode as $key => $lang) {
			...
			if ($ep4CEONURIDoesExist == true) { 
				$ceon_uri_mapping_admin->productPreviewProcessSubmission($current_category_id, $products_name, $products_model, $master_category, $pID, $uri_mapping_autogen);
...
//						print_r($row['v_uri']);
							...
							$rowselectpt = mysql_fetch_array($resultselectpt);
